...
function Footer() {
    return (
        <footer className="mt-32 md:mt-60  bg-[#FCAF3C] text-black relative">
            <Image width={800} height={200} priority={false} className="w-full object-cover absolute bottom-[96%] md:bottom-[70%] -z-10" src={footerWave} alt="footer wave" />
