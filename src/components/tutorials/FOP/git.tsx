  ...
  return (
    <div className="w-full bg-green-200 p-2 text-black">
      ...
      <div className="h-fit w-full bg-slate-200">
        ...
        <div className="section m-3 rounded-md bg-slate-300 p-3">
          <h3 className="text-lg font-bold">1.Setting up a new Repository</h3>
          <p>
            let us create new repository to store our code, in Git-Hub Follow
            the instructions
          </p>

          <p className="ml-12 w-fit rounded bg-slate-400 p-2">
            <li>open https://github.com/</li>

            <li>
              find &quot;<b> youre repositories</b> &quot; on the RHS
            </li>
            <li>
              press on &quot;<b> New</b> &quot; button again on the RHS{" "}
            </li>
        ...
        <div className="section m-3 rounded-md bg-slate-300 p-3">
          ...
          <p>
            IN this section we will be exploring how can we send the code we
            have in our system to our repository, that we created in the latest
            step
            <li>
              firstly open terminal, press on the <b> bottom-left</b> button or
              &quot; <b>ctrl+~</b> &quot; for shortcut
            </li>
            <li>
              {" "}
              Select <b>git Bash</b> as termina, Run the following commands{" "}
              <br />
              <div className="ml-12 w-fit rounded bg-slate-400 p-2">
                <li>git init</li>
                <li>git add .</li>
        ...
        <div className="section m-3 rounded-md bg-slate-300 p-3">
          ...
          <p>
            Finally, after pushing the code from the terminal we can see the
            code in our repo and move ahead for hosting it.
          </p>
        ...
        <div className="Note p-3">
          ...
          <div className="text ml-3 rounded-md bg-slate-300 p-2 ">
            ...
            following points <br />
            <div className="ml-6">
              1. All the features that are there through buttons in github are
              also there as commands to be used through terminal <br />
              2. to start with <i>these 3 commands</i> are sufficient
              <br />
              3. Developers prefer to using most of the features via terminal as
