...
export function Benifits() {
  return (
    <section className="relative z-50 mb-44 mt-20 flex flex-col items-center justify-center px-4 pb-4 font-sans sm:h-[145vh]  sm:px-8 md:px-16 xl:px-36">
      <div className="line-break "></div>
      <div className="event-bg "></div>
      <p
        className=" absolute bottom-auto left-1/2 right-0 top-36 w-max -translate-x-1/2 text-center text-[2.5rem]  text-transparent sm:top-24 md:top-14 md:block md:text-[5.25rem] lg:visible lg:text-8xl xl:text-9xl"
        style={{
      ...
      <div className="mb-24 mt-4 flex items-center justify-center">
      ...
      <div className="z-1 grid h-full w-full grid-cols-2  grid-rows-10  gap-4 sm:grid-cols-4 sm:grid-rows-5 lg:grid-cols-5 lg:grid-rows-4 ">
        ...
        <div className="grid-card relative col-span-1 col-start-2 col-end-3 row-span-2 row-start-1 row-end-3 flex flex-col items-center justify-center gap-y-4 rounded-2xl p-4 font-bebas-neue  text-xl tracking-widest sm:col-start-4 sm:col-end-5 sm:row-start-3  sm:row-end-5 sm:text-2xl sm:tracking-wide md:gap-y-8 md:text-3xl  md:tracking-wider lg:col-start-3 lg:col-end-3 lg:row-start-1 lg:row-end-3 lg:tracking-widest xl:text-4xl">
          <p>Real</p>
          <p>Time</p>
          <p>Projects</p>
        ...
        <div className="grid-card  relative col-span-2 row-span-2 flex flex-col items-center justify-center rounded-2xl  px-2 sm:col-start-1 sm:col-end-3 sm:row-start-2 sm:row-end-4 sm:py-2 md:py-4">
          <h1 className="font-bebas-neue text-xl font-extrabold  tracking-widest sm:text-2xl sm:tracking-wide md:text-3xl md:tracking-wider lg:tracking-widest xl:text-4xl">
            What is HackFest?
          </h1>
        ...
        <div className="grid-card relative col-span-1 row-span-1 flex items-center justify-center rounded-2xl px-2  font-bebas-neue text-xl  tracking-widest  sm:col-start-3 sm:col-end-4 sm:text-2xl sm:tracking-wide md:text-3xl  md:tracking-wider lg:col-start-4 lg:col-end-5 lg:row-start-2 lg:row-end-3 lg:tracking-widest xl:text-4xl">
          <p> Digital hunt</p>
          <Image
            src="/grid_bg_topdown.png"
            alt=""
        ...
        <div className="grid-card relative col-span-2 row-span-1 flex items-center justify-center rounded-2xl px-2 text-center font-bebas-neue text-xl  tracking-widest sm:col-start-2 sm:col-end-4  sm:row-start-4  sm:row-end-5 sm:text-2xl sm:tracking-wide md:text-3xl md:tracking-wider lg:col-start-3 lg:col-end-5 lg:row-start-3 lg:row-end-4 lg:tracking-widest xl:text-4xl">
        ...
        <div className="grid-card col-span- relative row-span-2 row-start-8  row-end-10 flex flex-col items-center justify-center gap-y-4 rounded-2xl p-4 text-center  font-bebas-neue  text-xl  tracking-widest sm:col-start-1 sm:col-end-2  sm:row-start-4 sm:row-end-6 sm:text-2xl sm:tracking-wide md:text-3xl  md:tracking-wider lg:col-start-5 lg:col-end-6 lg:row-start-3 lg:row-end-5 lg:tracking-widest xl:text-4xl">
          <p>Peer</p>
          <p>To</p>
          <p>Peer</p>
          <p>Learning</p>
