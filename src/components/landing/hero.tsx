...
function Hero() {
  return (
    <section className="absolute min-h-screen w-full place-content-center space-y-6 text-center ">
      <h1 className="bg-gradient-to-r from-amber-200 to-[#E98F81] bg-clip-text font-title text-4xl font-bold text-transparent sm:text-5xl md:text-5xl lg:text-9xl">
        ❝ FINITE LOOP CLUB ❞
      </h1>
      <p className="mx-auto max-w-sm text-center font-sub-heading font-thin md:text-xl">
