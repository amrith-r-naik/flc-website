...
function AboutFLC() {
  ...
  return (
    <section className="w-full content-container min-h-[80vh] mt-10 md:mt-80  bg-gradient   " >
            <h3 className='subheading text-center mb-12' ref={ref}>FINITELOOP The best Coding Club of NMAMIT</h3>
            <div className=' w-full h-full grid grid-cols-1 md:grid-cols-2 flex-grow items-center justify-items-center gap-4'>
                <div className="space-y-4">
                    ...
                    <ul className="space-y-2 text-gray-500 list-outside list-disc">
