    ...
    <div className="relative bottom-[-100px] right-2">
      <Dialog>
        <DialogTrigger asChild>
          <div className="w-fit  rounded-xl bg-[#1e1235] p-1 px-2 text-sm hover:text-slate-300  ">
            <LuPencil className="inline  text-sm" title="Upload Image" /> Edit
          </div>
        </DialogTrigger>
